...
public class AcmeBankTests
{
    ...
    public static readonly String batch_id = "testing_dont_close_batches";
    ...
    public static async Task SetUpConfigAndRunner()
    {
        ...
        if (UseUltrafastGrid)
        {
            ...
            Config.AddBrowser(1026, 1024, BrowserType.CHROME);
    ...
    public async Task OpenBrowserAndEyes()
    {
        ...
        cookies[0] = new Cookie() { Name = "cmstest", Value = "true", Path = "/", Domain = "test.asosservices.com" };
        cookies[1] = new Cookie() { Name = "cmstestqa", Value = "on", Path = "/", Domain = "test.asosservices.com" };
